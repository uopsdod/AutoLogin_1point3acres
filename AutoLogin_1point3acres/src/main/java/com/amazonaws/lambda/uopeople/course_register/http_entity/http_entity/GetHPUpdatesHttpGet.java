...
public class GetHPUpdatesHttpGet extends HttpGet {
//	static private final String loginUrl = "https://mycourses.uopeople.edu/RegisterForCourses/ConfirmRegistration";

    static private final String loginUrl = "https://mycourses.uopeople.edu/Account/GetHPUpdates";


	public GetHPUpdatesHttpGet() throws UnsupportedEncodingException {
		super(GetHPUpdatesHttpGet.loginUrl);
