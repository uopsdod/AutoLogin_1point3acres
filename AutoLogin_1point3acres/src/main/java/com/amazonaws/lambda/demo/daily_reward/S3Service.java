...
public class S3Service {
	...
	public S3Service(String accessKey, String secretKey, String region) {
		...
		s3 = AmazonS3ClientBuilder.standard().withCredentials(new AWSStaticCredentialsProvider(creds)).withRegion(Regions.fromName(region)).build();
	}
	...
	public S3Object getObject(String bucketName, String key) {
		return this.s3.getObject(new GetObjectRequest(bucketName, key));
	}
	
	public ObjectListing listObjects(String bucketName, String prefix) {
		return this.s3.listObjects(new ListObjectsRequest()
    ...
    public static void test(String accessKey, String secretKey, String region) throws IOException {
        ...
        try {
            ...
            s3Service.putObject(bucketName, key, createSampleFile());
            ...
            ObjectListing objectListing = s3Service.listObjects(bucketName, "My");
